...
# Order: 0 total, 1 pT, 2-8 pT fits in abseta bins, 9 abseta, 10 eta, 11-12 centrality   NOTE: IS NOT SAME AS SCENARIO
    cms.PSet(
        MuId_1bin = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("hltL1fL1sDoubleMu0BptxANDL1Filtered0","true"),
...
if scenario == "11": EFFICIENCYSET = cms.PSet(VEFFICIENCYSET[14])
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
 ...
 #   InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_pPb/Data/PASingleMuon_PARun2016C-PromptReco-v1TnpTress_Pbpv1CentralityInfo.root"),
    ...
    Variables = cms.PSet(
                         mass             = cms.vstring("Tag-Probe Mass", "2.8", "3.4", "GeV/c^{2}"), # mass range syst: 2.8-3.4
    ...
    Categories = cms.PSet(
                        ...
                        hltL1fL1sDoubleMu0BptxANDL1Filtered0 = cms.vstring("hltL1fL1sDoubleMu0BptxANDL1Filtered0", "dummy[true=1,false=0]"),
